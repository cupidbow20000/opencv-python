...
def draw_rectangle(event, x, y, flags, params):
	...
	# Detecting the mouse button up event
		...
		# rect_final = (50, 50, x-x_init, y-y_init)
		# x, y, w, h = rect_final
		# Remove the object in the selected region
		remove_object(img_orig, rect_final)
		# remove_object(img_orig[y_init - 50:y + 50, x_init - 50:x + 50], rect_final)
...
def remove_object(img, rect_roi):
	...
	# cv2.imshow('Repaired Image', img_output)
...
if __name__=='__main__':
	...
	# img_input = cv2.resize(img_input, None, fx=0.5, fy=0.5, interpolation=cv2.INTER_LINEAR)
	drawing = False
